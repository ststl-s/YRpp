...
ALIAS_O(BytePalette *, FileSystem::TEMPERAT_PAL, 0x885780);
ALIAS_O(BytePalette *, FileSystem::GRFXTXT_PAL, 0xA8F790);
ALIAS(ConvertClass *, FileSystem::CAMEO_PAL, 0x87F6B0);
ALIAS(ConvertClass *, FileSystem::UNITx_PAL, 0x87F6B4);
ALIAS(ConvertClass *, FileSystem::PALETTE_PAL, 0x87F6C4);
